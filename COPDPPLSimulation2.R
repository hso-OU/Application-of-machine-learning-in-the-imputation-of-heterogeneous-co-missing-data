...
load("MedMissingPpl.Rdata")
Ppl.Data2$entity_id <- as.integer(Ppl.Data2$entity_id)

Strat_sample.func(Ppl.Data2, sample.frac = 0.5,  
                  file.name="Miss_Med_Size_Med_Strat_Sample.csv", iter=10000, rand.seed=1)

Strat_sample.func(Ppl.Data2, sample.frac = 0.1,  
                  file.name="Miss_Med_Size_Sml_Strat_Sample.csv", iter=10000, rand.seed=4)

Strat_sample.func(Ppl.Data2, sample.frac = 1,  
                  file.name="Miss_Med_Size_Lrg_Strat_Sample.csv", iter=10000, rand.seed=7)
###############################################################################################
# hid.ratio<- function(data= Ppl.Data2) { c(0.75, 0.65)[data$Disease1 + 1] }  
# FEV1FVC.func <- function(hid.ratio, FVC ){ hid.ratio* FVC  + rnorm(length(FVC))* 0} 
# Ppl.Data2 <-PPL.Disease.Missing.func(Ppl.Data2,hid.ratio, FEV1FVC.func, Disease.prob.func,
...
load(file="SmlMissingPpl.Rdata")
Ppl.Data2$entity_id <- as.integer(Ppl.Data2$entity_id)


Strat_sample.func(Ppl.Data2, sample.frac = 0.5,  
                  file.name="Miss_Sml_Size_Med_Strat_Sample.csv", iter=10000, rand.seed=1+1)

Strat_sample.func(Ppl.Data2, sample.frac = 0.1,  
                  file.name="Miss_Sml_Size_Sml_Strat_Sample.csv", iter=10000, rand.seed=4+1)

Strat_sample.func(Ppl.Data2, sample.frac = 1,  
                  file.name="Miss_Sml_Size_Lrg_Strat_Sample.csv", iter=10000, rand.seed=7+1)
###############################################################################################
# hid.ratio<- function(data= Ppl.Data2) { c(0.75, 0.65)[data$Disease1 + 1] }  
# FEV1FVC.func <- function(hid.ratio, FVC ){ hid.ratio* FVC  + rnorm(length(FVC))* 0} 
# Ppl.Data2 <-PPL.Disease.Missing.func(Ppl.Data2,hid.ratio, FEV1FVC.func, Disease.prob.func,
...
load(file="LrgMissingPpl.Rdata")
Ppl.Data2$entity_id <- as.integer(Ppl.Data2$entity_id)


Strat_sample.func(Ppl.Data2, sample.frac = 0.5,  
                  file.name="Miss_Lrg_Size_Med_Strat_Sample.csv", iter=10000, rand.seed=1+2)

Strat_sample.func(Ppl.Data2, sample.frac = 0.1,  
                  file.name="Miss_Lrg_Size_Sml_Strat_Sample.csv", iter=10000, rand.seed=4+2)

Strat_sample.func(Ppl.Data2, sample.frac = 1,  
                  file.name="Miss_Lrg_Size_Lrg_Strat_Sample.csv", iter=10000, rand.seed=7+2)